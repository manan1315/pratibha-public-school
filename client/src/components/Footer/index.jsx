        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold font-['Playfair_Display']">PRATIBHA PUBLIC SCHOOL</h3>
            ...
            <p className="text-[#f9a825] text-xs font-semibold mb-6">
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 font-['Playfair_Display']">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 font-['Playfair_Display']">Contact Info</h3>
          ...
          {/* Column 4: Map */}
          <div>
            <h3 className="text-lg font-bold mb-6 font-['Playfair_Display']">Our Location</h3>
