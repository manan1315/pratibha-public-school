...
const Section = ({ icon, title, content, tint }) => (
  <div className="card text-center">
    <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-2xl ${tint}`}>
      {icon}
    </div>
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-[#1a237e] to-[#0d1452] py-20">
        <div className="max-w-7xl mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold font-['Playfair_Display'] mb-4">About Us</h1>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div id="vision" className="grid md:grid-cols-3 gap-8 mb-16">
            <Section
              icon={<FiTarget />}
          ...
          {/* Managing committee */}
          {society && (
            <div id="society" className="bg-gray-50 rounded-2xl p-8 mb-16">
          ...
          {leadership.length > 0 && (
            <>
              <div id="leadership" className="text-center mb-12">
                  ...
                  <div key={p._id} className="card text-center">
                    <div className="w-32 h-32 mx-auto mb-4 rounded-full overflow-hidden border-4 border-[#f9a825] bg-gray-100">
                      {p.photo ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-3xl font-bold text-[#1a237e]">
                          {p.name?.charAt(0)}
                        </div>
                      )}
                    </div>
                  ...
                  <div key={t._id} className="card text-center">
                    <div className="w-24 h-24 mx-auto mb-3 rounded-full overflow-hidden border-2 border-[#1a237e]/20 bg-gray-100">
                      {t.photo ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-2xl font-bold text-[#1a237e]">
                          {t.name?.charAt(0)}
                        </div>
                      )}
                    </div>
