    ...
    <div>
      <div className="bg-gradient-to-r from-[#1a237e] to-[#0d1452] py-8">
        <div className="max-w-7xl mx-auto px-4 text-center text-white">
          <h1 className="text-3xl md:text-xl sm:text-xl sm:text-2xl font-bold font-['Playfair_Display'] mb-2.5">Downloads</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
            {downloads.length > 0 ? downloads.map((item) => (
              <div key={item._id} className="card">
                ...
                <p className="text-gray-600 text-sm mb-2.5">{item.description}</p>
