    ...
    <div>
      <div className="bg-gradient-to-r from-[#1a237e] to-[#0d1452] py-20">
        <div className="max-w-7xl mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold font-['Playfair_Display'] mb-4">Academics</h1>
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-md">
                <FiCalendar className="text-[#1a237e] text-3xl mb-3" />
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                <FiFileText className="text-[#1a237e] text-3xl mb-3" />
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                <FiBookOpen className="text-[#1a237e] text-3xl mb-3" />
