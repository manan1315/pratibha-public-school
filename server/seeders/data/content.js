...
module.exports.achievements = [
  { title: 'District Topper — CGBSE Class 12', description: 'Secured 96.4% and ranked 2nd in Mahasamund district in the Science stream.', image: IMG.class, studentName: 'Nikita Sahu', category: 'Academic', year: '2025', isActive: true },
...
module.exports.testimonials = [
  ...
  { name: 'Nikita Sahu', relation: 'Alumna, Batch 2025', quote: 'The teachers here pushed me to aim beyond the district. I scored 96.4% in CGBSE and got into an engineering college in Raipur. PPS built my foundation.', photo: IMG.woman2, rating: 5, isActive: true },
...
module.exports.faqs = [
  ...
  { question: 'Which board is the school affiliated to?', answer: 'Pratibha Public School Basna is affiliated to CGBSE (Chhattisgarh Board of Secondary Education) and offers classes from Nursery to Class 12.', category: 'Academics', order: 4, isActive: true },
